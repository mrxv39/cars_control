  ...
  return (
    <div className="catalog-page">
      ...
      <section className="catalog-hero-banner">
        ...
        {/* Search + filtros en el hero, misma fila */}
        <div className="catalog-hero-bar">
          ...
          <select value={priceMax} onChange={(e) => setPriceMax(e.target.value)} aria-label="Precio máximo" className={`catalog-hero-chip ${priceMax ? "active" : ""}`}>
          ...
          <select value={yearMin} onChange={(e) => setYearMin(e.target.value)} aria-label="Año mínimo" className={`catalog-hero-chip ${yearMin ? "active" : ""}`}>
